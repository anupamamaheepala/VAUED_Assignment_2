...
// ── Circular Gauge ────────────────────────────────────────────────────────────
function Gauge({ value, max, label, sublabel, color, trackColor, footnote, footnoteColor }) {
  const r = 40;
    ...
    >
      ...
      >
        <span className="material-symbols-outlined" style={{ fontSize: "36px", color: C.onSurfaceVariant }}>
          {label === "SOIL MOISTURE" ? "water_drop" : label === "SOIL PH BALANCE" ? "science" : "wb_sunny"}
        </span>
      </div>
  ...
  const crops = [
    {
      ...
      statusGlow: "rgba(136,217,130,0.6)",
      risk: "Low",
      riskBg: "rgba(136,217,130,0.1)",
      riskColor: C.primary,
      sync: "14:20 PM",
    },
    {
      ...
      statusGlow: "rgba(254,179,0,0.6)",
      risk: "Medium",
      riskBg: "rgba(254,179,0,0.1)",
      riskColor: C.secondaryContainer,
      sync: "14:15 PM",
    },
    {
      icon: "nutrition",
      ...
      status: "Critical",
      statusColor: C.error,
      statusGlow: "rgba(255,180,171,0.6)",
      risk: "Medium",
      riskBg: "rgba(254,179,0,0.1)",
      riskColor: C.secondaryContainer,
      sync: "13:58 PM",
    ...
    <div style={{ minHeight: "100vh", background: C.bg, color: C.onSurface, fontFamily: fontBody, display: "flex" }}>
      ...
      >
        ...
        <div style={{ width: "320px", position: "relative", marginRight: "16px" }}>
          <span className="material-symbols-outlined" style={{ position: "absolute", left: "12px", top: "50%", transform: "translateY(-50%)", color: C.stone400, fontSize: "16px" }}>
            search
          </span>
          <input
                  ...
                  >
                    ...
                    <td style={{ padding: "20px 32px" }}>
                      <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                        ...
                        >
                          <span className="material-symbols-outlined" style={{ fontSize: "16px", color: crop.iconColor }}>
                            {crop.icon}
                          </span>
                        </div>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                        <span
                          style={{
                            ...
                            height: "10px",
                            borderRadius: "50%",
                            background: crop.statusColor,
                            boxShadow: `0 0 8px ${crop.statusGlow}`,
                            flexShrink: 0,
                          }}
                        />
                    ...
                    <td style={{ padding: "20px 32px" }}>
                      <span
                        style={{
                          ...
                          padding: "3px 10px",
                          borderRadius: "9999px",
                          background: crop.riskBg,
                          color: crop.riskColor,
                        }}
                      >
                        {crop.risk}
                      </span>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            <div style={{ ...glassPanel, borderRadius: "12px", padding: "24px" }}>
              ...
              <p style={{ fontSize: "14px", color: C.onSurfaceVariant, lineHeight: "1.65", margin: 0 }}>
                Detecting{" "}
                <strong style={{ color: C.secondaryContainer }}>nutrient leaching</strong>{" "}
                in Section B (Tomato crops). Moisture levels exceed optimal range by 12%.
              </p>
              ...
              >
                ...
                >
                  ...
                  <span style={{ fontSize: "12px", fontWeight: "700", color: C.primary }}>94%</span>
                </div>
                ...
                <button
                  style={{
                    ...
                    gap: "8px",
                    fontFamily: fontBody,
                    boxShadow: "0 4px 20px rgba(136,217,130,0.2)",
                  }}
                >
            ...
            <div style={{ ...glassPanel, borderRadius: "12px", padding: "24px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                {[
                  { label: "Soil Sensors", value: "12 / 12", pct: 100 },
                  { label: "Light Nodes", value: "8 / 8", pct: 100 },
                ].map(({ label, value, pct }) => (
                  <div key={label}>
